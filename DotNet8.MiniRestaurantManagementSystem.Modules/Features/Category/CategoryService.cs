...
public class CategoryService : ICategoryService
{
    ...
    )
    {
        ...
        try
        {
            var lst = await _context
                .TblCategories.OrderByDescending(x => x.CategoryId)
    ...
    public async Task<Result<CategoryDto>> GetCategoryByCodeAsync(
        string categoryCode,
        CancellationToken cancellationToken
    )
    {
    ...
    {
        return await _context.TblCategories.AnyAsync(
            expression,
            cancellationToken: cancellationToken
        );
    }
    ...
    {
        return await _context.TblCategories.FirstOrDefaultAsync(
            expression,
            cancellationToken: cancellationToken
        );
    }
